  ...
  <div class='container-fluid'>
    ...
    <?php } ?>
      ...
      <?php
          ...
          echo form_open('admin/tambahGrupBaru', $attributes);
      ?>
        <div class='card-body'>
          <div class="form-group has-feedback">
              <label for="grup" class="col-sm-4 control-label">Nama Grup</label>
              <input type="text" class="form-control" placeholder="Nama Grup" name="nama_grup" value="<?php echo $nama_tambah_grup ?>">
          </div>
        </div>
        <!-- /.card-body -->
        <div class='card-footer'>
          <input type="hidden" name="baseURL" id="baseURL" value="<?php echo base_url() ?>" />
          <?php if(isset($priviliges->{15})){ ?>
