...
class AdjiGenerator extends CI_Controller {
    ...
    public function help(){
        ...
        $result .= "php index.php AdjiGenerator crud_foreignkey ControllerName table_Name table_foreign_one table_foreign_two table_foreign_three table_foreign_four table_foreignkey_five \r\n";
        $result .= "php index.php AdjiGenerator restApi ControllerName table_Name \r\n";
        $result .= "php index.php AdjiGenerator restApi_foreignkey ControllerName table_Name table_foreign_one table_foreign_two \r\n";
    ...
    public function crud_foreignkey ($controller="", $table="", $table_foreignkey_one="", $table_foreignkey_two="", $table_foreignkey_three="", $table_foreignkey_four="", $table_foreignkey_five=""){
        //load controller
        $admin_controller = admin_foreignkey_controller($controller, $table, $table_foreignkey_one, $table_foreignkey_two, $table_foreignkey_three, $table_foreignkey_four, $table_foreignkey_five, $this->buttonTambah, $this->buttonTambahAksi, $this->buttonEdit, $this->buttonEditAksi, $this->buttonHapus, $this->buttonPdf, $this->buttonExcel);

        //load template index
        template_foreignkey_index($controller, $table, $table_foreignkey_one, $table_foreignkey_two, $table_foreignkey_three, $table_foreignkey_four, $table_foreignkey_five, $admin_controller['buttonTambah'], $admin_controller['buttonTambahAksi'], $admin_controller['buttonEdit'], $admin_controller['buttonEditAksi'], $admin_controller['buttonHapus'], $admin_controller['buttonPdf'], $admin_controller['buttonExcel']);

        //load template tambah
        template_foreignkey_tambah($controller, $table, $table_foreignkey_one, $table_foreignkey_two, $table_foreignkey_three, $table_foreignkey_four, $table_foreignkey_five, $admin_controller['buttonTambah'], $admin_controller['buttonTambahAksi'], $admin_controller['buttonEdit'], $admin_controller['buttonEditAksi'], $admin_controller['buttonHapus']);

        //load template edit
        template_foreignkey_edit($controller, $table, $table_foreignkey_one, $table_foreignkey_two, $table_foreignkey_three, $table_foreignkey_four, $table_foreignkey_five, $admin_controller['buttonTambah'], $admin_controller['buttonTambahAksi'], $admin_controller['buttonEdit'], $admin_controller['buttonEditAksi'], $admin_controller['buttonHapus']);

        //load template pdf
        template_foreignkey_pdf($controller, $table);
        
        //load models
        model_foreignkey_generator($controller, $table, $table_foreignkey_one, $table_foreignkey_two, $table_foreignkey_three, $table_foreignkey_four, $table_foreignkey_five);
        ...
        echo "table foreign three ".$table_foreignkey_three."\r\n";
        echo "table foreign four ".$table_foreignkey_four."\r\n";
        echo "table foreign five ".$table_foreignkey_five."\r\n";
    }
